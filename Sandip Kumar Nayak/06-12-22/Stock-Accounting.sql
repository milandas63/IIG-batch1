...
INSERT INTO stock VALUES
    (1,     "EZ0316",      "03/2024",      "02/2022",        59.00,       65.00,      75.00,      100.00,     1,	NULL, NULL);
...
CREATE TABLE trn_header(
	...
	trn_tax_amount          DOUBLE(10,3)        DEFAULT 0.00,
	trn_disc_amount         DOUBLE(10,3)        DEFAULT 0.00,
	user_id					INT(6)				NOT NULL REFERENCES user(user_id),
	last_update				TIMESTAMP			NOT NULL,
    del                		ENUM("*")           DEFAULT NULL,
...
INSERT INTO trn_header VALUES
    (1,   22/10/2022,   1,   2,   1,  2300.98,    67.058,   87.86,   1,     NULL,    NULL);
...
INSERT INTO trn_detail VALUES
    (1,    1,    "EZ0316",       "22/11/2022",        "25/03/2024",       59.00,     65.00,      75.00,      3000.00,        300.00,  15.50,  600,  1, null,     null);
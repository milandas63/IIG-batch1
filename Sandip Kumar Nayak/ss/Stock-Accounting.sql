...
INSERT INTO config VALUES
	(1, 'I-Hub Pvt Ltd', 'Health is Wealth', 'INFOCITY', 10, 5678, 1, NULL, NULL);
...
INSERT INTO product VALUES
	...
	(28,  2,    "Ahaglow S Foaming Face Wash",                                  "N",    1,	NULL, NULL),
	(29,  2,    "Allerfex 120mg Tablet",                                        "N",    1,	NULL, NULL),
	(30,  2,    "Alprax 0.25 Tablet",                                           "N",    1,	NULL, NULL),
	(31,  2,    "Alprax 0.5mg Tablet",                                          "N",    1,	NULL, NULL),
	(32,  2,    "Alprax 1mg Tablet SR",                                         "N",    1,	NULL, NULL),
	(33,  2,    "Alprax Plus Tablet SR",                                        "N",    1,	NULL, NULL),
	(34,  2,    "Altipod 100mg Tablet DT",                                      "N",    1,	NULL, NULL),
	(35,  2,    "Altipod CV 100mg/62.5mg Tablet DT",                            "N",    1,	NULL, NULL),
	(36,  2,    "Amazeo 100 Tablet",                                            "N",    1,	NULL, NULL),
	(37,  2,    "Amazeo 200 Tablet",                                            "N",    1,	NULL, NULL),
	(38,  2,    "Amazeo OD 50mg Tablet",                                        "N",    1,	NULL, NULL),
	(39,  2,    "Ambiz 10mg Tablet",                                            "N",    1,	NULL, NULL),
	(40,  2,    "Amifru 40 Tablet",                                             "N",    1,	NULL, NULL),
	(41,  2,    "Amlocor 10mg Tablet",                                          "N",    1,	NULL, NULL),
	(42,  2,    "Amlocor 5mg Tablet",                                           "N",    1,	NULL, NULL),
	(43,  2,    "Ampoxin LB Capsule",                                           "N",    1,	NULL, NULL),
	(44,  2,    "Ampoxin-CV 200mg/28.5mg Suspension",                           "N",    1,	NULL, NULL),
	(45,  2,    "Androz 25mg Tablet",                                           "N",    1,	NULL, NULL),
	(46,  2,    "Androz 50mg Tablet",                                           "N",    1,	NULL, NULL),
	(47,  2,    "Angiopril 25mg Tablet",                                        "N",    1,	NULL, NULL),
	(48,  2,    "Anticox 4 Kit",                                                "N",    1,	NULL, NULL),
	(49,  2,    "Anticox II 450 mg/300 mg Tablet",                              "N",    1,	NULL, NULL),
	(50,  2,    "Anticox Z 450 mg/300 mg/750 mg Tablet",                        "N",    1,	NULL, NULL),
	(51,  2,    "Anxipar 0.25mg Tablet",                                        "N",    1,	NULL, NULL),
	(52,  2,    "Arip MT 20 Tablet",                                            "N",    1,	NULL, NULL),
	(53,  2,    "Arip MT 30 Tablet",                                            "N",    1,	NULL, NULL),
	(54,  2,    "Arkamin H Tablet",                                             "N",    1,	NULL, NULL),
	(55,  2,    "Aroff 200mg Tablet SR",                                        "N",    1,	NULL, NULL),
	(56,  2,    "Asthafen Syrup",                                               "N",    1,	NULL, NULL),
	(57,  2,    "Asthafen Tablet",                                              "N",    1,	NULL, NULL),
	(58,  2,    "Asthesia Cream",                                               "N",    1,	NULL, NULL),
	(59,  2,    "Atlura 40 Tablet",                                             "N",    1,	NULL, NULL),
	(60,  2,    "Atlura 80 Tablet",                                             "N",    1,	NULL, NULL),
	(61,  2,    "Atmost 50mg Tablet",                                           "N",    1,	NULL, NULL),
	(62,  2,    "Azibold 100mg/5ml Syrup",                                      "N",    1,	NULL, NULL),
	(63,  2,    "Azisuper 100mg Suspension",                                    "N",    1,	NULL, NULL),
	(64,  2,    "Azisuper 500mg Tablet",                                        "N",    1,	NULL, NULL),
	(65,  2,    "Azona 20mg Capsule",                                           "N",    1,	NULL, NULL);
...
CREATE TABLE trn_header(
	...
	trn_amount              DOUBLE(20,2)        DEFAULT NULL,
	trn_tax_amount          DOUBLE(20,2)        DEFAULT NULL,
	trn_disc_amount         DOUBLE(20,2)        DEFAULT NULL,
    user_id					INT(6)				NOT NULL REFERENCES user(user_id),
	last_update				TIMESTAMP           DEFAULT NULL,
    del                		ENUM("*")           DEFAULT NULL,
...
INSERT INTO trn_header VALUES
    (1,  "06/12/22",  1,  1,  2,   55.00,  3.00,   2.00,  1,   NULL,   NULL);
...
CREATE TABLE trn_detail(
    ...
    rate_purchase     		DOUBLE(20,3)        NOT NULL,
    rate_sale         		DOUBLE(20,3)        NOT NULL,
    rate_mrp          		DOUBLE(20,3)        NOT NULL,
    qty               		INT(255)            NOT NULL,
    free              		ENUM("Y","N")       NOT NULL,
    tax_pc                  DOUBLE(20,3)        NOT NULL,
    user_id			        INT(6)		        NOT NULL REFERENCES user(user_id),
    last_update		        TIMESTAMP	        DEFAULT NULL,
    del                		ENUM("*")           DEFAULT NULL,
...
INSERT INTO trn_detail VALUES
    (1,    1,      "EZ0316",        "25/03/2024",       "21/02/2022",       59.00,     65.00,      75.00,      3000,       "Y",       6.00,   1,  NULL,  NULL);

...
CREATE TABLE product(
    mfg_id              INT(20)             DEFAULT NULL AUTO_INCREMENT,
...
INSERT INTO product VALUES
    ...
    (2,   2,   "A-Derma Epitheliale A.H Duo Cream",                        "FALSE",    null),
    (3,   3,   "A-Derma Exomega Emollient Cream",                          "FALSE",    null),
    (4,   4,   "A-Derma Protect Fluid Cream SPF 50+",                      "FALSE",    null),
    (5,   5,   "ADVACORT 6MG TABLET",                                      "FALSE",    null),
    (6,   6,   "Abact 250mg Tablet",                                       "FALSE",    null),
    (7,   7,   "Abamlo 5 Tablet",                                          "FALSE",    null),
    (8,   8,   "Abbott Gel Hand Sanitizer",                                "FALSE",    null),
    (9,   9,   "Abbott Panbio Covid 19 Antigen Self Test Kit",             "TRUE",     null),
    (10,  10,  "Abbott Supra Rize Cholecalciferol USP 60,000IU Capsule",   "FALSE",    null),
    (11,  11,  "Abetorox 60 Tablet",                                       "FALSE",    null),
    (12,  12,  "Abixim 200mg Tablet",                                      "FALSE",    null),
    (13,  13,  "Abmetop 50 XL Tablet",                                     "FALSE",    null),
    (14,  14,  "Abnib 250mg Tablet",                                       "FALSE",    null),
    (15,  15,  "Abocal 500 Tablet",                                        "FALSE",    null),
    (16,  16,  "Abtelmi-Amh Tablet",                                       "FALSE",    null),
    (17,  17,  "Abtorsmed 10 Tablet",                                      "FALSE",    null),
    (18,  18,  "Abturbi Cream",                                            "FALSE",    null);

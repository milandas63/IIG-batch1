...
CREATE TABLE Answre(
	 Answre_id				INT(6)				NOT NULL AUTO_INCREMENT,
	 Answre_name			VARCHAR(100)		        NOT NULL,
	 Answre_desc			VARCHAR(200)		        DEFAULT NULL,
	 Answre_abbr			VARCHAR(20)			        DEFAULT NULL,
	   del			       ENUM("*")	                    DEFAULT NULL,
	PRIMARY KEY(Answre_id)
);
INSERT INTO Answre( Answre_name,  Answre_desc,  Answre_abbr) VALUES
...
INSERT INTO Generate(Generate_name, Generate_desc, Generate_abbr)
